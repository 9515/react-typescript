...
// // Promise类型必须要参数， resolve 数据的泛型
// // MemberEntity 一条数据要满足的接口
// // MemberEntity[] ts 数组每一项的类型 [1,'222', ture]
// // ajax 数据请求
...
//     saveMember,
//     fetchMemberById
//     // 根据id 取出member 显示出来 state 更新一下 -1 login
// }
